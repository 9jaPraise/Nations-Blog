  ...
  <body>
    <div id="wrapper">
      ...
      <div class="sidebar">
        ...
        <p class="brand-title"><a href="">Nations Blog</a></p>
        ...
        <div class="side-links">
          <ul>
            ...
            @auth
            <li><a class="{{Request::routeIs('dashboard') ? 'dashboard' : ''}}" href="{{route('dashboard')}}">Dashboard</a></li>
            @endauth
          </ul>
        </div>
        ...
        <footer class="sidebar-footer">
          ...
          <small>&copy 2023 Nations Blog</small>
        </footer>
      </div>
      <!-- Menu Button -->
